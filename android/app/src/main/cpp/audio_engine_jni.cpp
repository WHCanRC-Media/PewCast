...
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeStart(JNIEnv* env, jobject thiz,
...
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeGetListenPort(JNIEnv* env, jobject thiz) {
    return gEngine ? gEngine->getListenPort() : 0;
}

JNIEXPORT void JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeStop(JNIEnv* env, jobject thiz) {
    if (gEngine) {
        gEngine->stop();
        delete gEngine;
        gEngine = nullptr;
...
JNIEXPORT void JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeSetTargetBufferMs(JNIEnv* env, jobject thiz, jint ms) {
    if (gEngine) {
...
JNIEXPORT jint JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeGetBufferMs(JNIEnv* env, jobject thiz) {
    return gEngine ? gEngine->getBufferMs() : 0;
}

JNIEXPORT jfloat JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeGetPlaybackRate(JNIEnv* env, jobject thiz) {
    return gEngine ? gEngine->getPlaybackRate() : 1.0f;
}

JNIEXPORT jint JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeGetLostPackets(JNIEnv* env, jobject thiz) {
    return gEngine ? gEngine->getLostPackets() : 0;
}

JNIEXPORT jint JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeGetUnderruns(JNIEnv* env, jobject thiz) {
    return gEngine ? gEngine->getUnderruns() : 0;
}

JNIEXPORT jfloat JNICALL
Java_org_whcanrc_assistedlistening_audio_AudioEngine_nativeGetPeakLevel(JNIEnv* env, jobject thiz) {
...
JNIEXPORT jint JNICALL
Java_org_whcanrc_assistedlistening_audio_ChirpTester_nativeGetListenPort(JNIEnv* env, jobject thiz) {
    return gChirpTester ? gChirpTester->getListenPort() : 0;
}

JNIEXPORT void JNICALL
Java_org_whcanrc_assistedlistening_audio_ChirpTester_nativeStopTest(JNIEnv* env, jobject thiz) {
    if (gChirpTester) {
...
JNIEXPORT void JNICALL
Java_org_whcanrc_assistedlistening_audio_ChirpTester_nativeShutdown(JNIEnv* env, jobject thiz) {
    if (gChirpTester) {
        gChirpTester->stopTest();
...
JNIEXPORT jint JNICALL
Java_org_whcanrc_assistedlistening_audio_ChirpTester_nativeGetLatencyMs(JNIEnv* env, jobject thiz) {
